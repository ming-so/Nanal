...
public class CreateDiaryDialogFragment extends DialogFragment implements TextWatcher {
    private static final String TAG = "CreateDiaryDialogFragment";
    ...
    private com.android.nanal.diary.CreateDiaryDialogFragment.CalendarQueryService mService;
    ...
    public CreateDiaryDialogFragment() {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = layoutInflater.inflate(R.layout.create_diary_dialog, null);

        mColor = view.findViewById(R.id.d_color);
        mCalendarName = (TextView) view.findViewById(R.id.d_calendar_name);
        mAccountName = (TextView) view.findViewById(R.id.d_account_name);

        mEventTitle = (EditText) view.findViewById(R.id.diary_title);
...
//                                createAllDayEvent();
    ...
    public void onActivityCreated(Bundle args) {
        ...
        mService.startQuery(TOKEN_CALENDARS, null, Calendars.CONTENT_URI,
                ...
                EditDiaryHelper.CALENDARS_WHERE_WRITEABLE_VISIBLE, null,
                null);
    }
