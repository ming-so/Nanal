...
public class TimeZoneInfo implements Comparable<TimeZoneInfo> {
     ...
     * mFormatter는 인스턴스당 mSB 하나를 사용하기 때문에 메소드가 동기화됨
     * getGmtDisplayName에 대한 호출이 여러 개 있는 경우, 출력이 좋지 않을 수 있음
     */
     ...
     * 해당 인스턴스가 작다면 음수, 크다면 양수, 같다면 0 리턴
     */
    @Override
