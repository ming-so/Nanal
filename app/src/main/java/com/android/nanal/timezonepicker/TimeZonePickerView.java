...
public class TimeZonePickerView extends LinearLayout implements TextWatcher, OnItemClickListener,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        // 무한 루프 없이 AutoCompleteTextView를 업데이트하는 방법을 찾지 못했기 때문에
        // view 아이템에 대한 onClickListener 사용
    ...
    // 어댑터가 설정되지 않은 경우 어댑터 설정
    // 어댑터가 있으면, AutoCompleteTextView.setText()가 드롭다운을 트리거하므로
    // 방향 변경시 드롭다운의 변경이 반영되지 않은 상태가 되지 않기 위해 어댑터를 초기화함
