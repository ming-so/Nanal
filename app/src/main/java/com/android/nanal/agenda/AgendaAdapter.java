...
// 해야 할 것: agenda, month, widget, 폴더 없는 파일
/*
...
import com.android.nanal.color.ColorChipView;
...
public class AgendaAdapter extends ResourceCursorAdapter {
    ...
    // Formatter가 안전한 스레드가 아님, 메인 스레드에서만 사용되기 때문에 현재로서는 괜찮음
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        // 다른 타입의 뷰로 계속해서 데이터를 이동하기 때문에, ListView가 혼란스러워질 수 있음
        ...
        // 이벤트가 거절된 경우? 줄어든 경우? 텍스트를 페이드하고 컬러 칩 모드를 설정함
        ...
        // 모든 어댑터를 업데이트하는 것은 어렵기 때문에, 뷰를 작성해야 할 때마다 묻기
